<template>
  <view class="requisition-list-page">
...
export default {
  ...
  methods: {
    ...
    goToDetail(id) {
      uni.navigateTo({ url: `/pages/requisition/detail?id=${id}` })
    },
    goToCreate() {
      uni.navigateTo({ url: '/pages/requisition/create' })
    }
  }
}
</script>
